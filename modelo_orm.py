...
class Obra(BaseModel):
  ...
  def nuevo_proyecto(self, nombre, descripcion, porcentaje_avance, destacada, id_barrio, id_entorno, id_tipo_obra, id_etapa, id_licitacion_oferta_empresa, monto_contrato, plazo_meses, beneficiarios, mano_obra):
    try:
